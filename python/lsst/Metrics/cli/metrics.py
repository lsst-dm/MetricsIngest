...
class MetricsCommand(MWCommand):
    """Command subclass with Metrics-command specific overrides."""

    extra_epilog = "See 'metrics --help' for more options."


class MetricsCli(LoaderCLI):

    localCmdPkg = "lsst.Metrics.cli.cmd"


@click.command(cls=MetricsCli,
