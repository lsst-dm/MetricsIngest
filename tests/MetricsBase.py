# This file is part of metrics package.
#
...
# coding: utf-8
"""Base for tests of metrics functions."""
...
TEST_DATA_FNAME = os.path.join(
    os.environ["METRICS_DIR"], "tests", "data", "test_metrics.tgz"
)
...
class MetricsTestBase:
    def setUp(self):
        ...
        self.test_dir = os.path.join(self.temp_dir.name, "test_metrics")
